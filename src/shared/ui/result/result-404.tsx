...
export interface Result404Props extends SVGProps<SVGSVGElement> {
	className?: string
}

const Result404 = forwardRef<SVGSVGElement, Result404Props>(
	({ className, ...props }, ref) => {
		return (
			<svg
				ref={ref}
...
Result404.displayName = "Result404"

export default memo(Result404)
